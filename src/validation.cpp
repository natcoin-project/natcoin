...
#if defined(NDEBUG)
# error "Natcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Natcoin Signed Message:\n";
...
{
    int halvings = nHeight / consensusParams.nSubsidyHalvingInterval; // natcoin: 250k blocks in ~4 years
