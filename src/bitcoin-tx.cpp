...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s natcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  natcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded natcoin transaction") + "\n" +
              "  natcoin-tx [options] -create [commands]   " + _("Create hex-encoded natcoin transaction") + "\n" +
              "\n";
