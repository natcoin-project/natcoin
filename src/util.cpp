...
const char * const BITCOIN_CONF_FILENAME = "natcoin.conf";
const char * const BITCOIN_PID_FILENAME = "natcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Natcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Natcoin";
#else
    // Unix
    return pathRet / ".natcoin";
#endif
#endif
}
